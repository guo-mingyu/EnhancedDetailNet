...
# Compute class weights and create a sampler
class_counts = torch.bincount(torch.tensor(train_dataset.get_labels()))
...
for epoch in range(args.num_epochs):
    ...
    if (epoch + 1) % args.save_interval == 0:
        torch.save(model.state_dict(), f"DataEnhancement_model_epoch_lr{args.learning_rate}_{args.channel_mode}{epoch + 1}.pth")
